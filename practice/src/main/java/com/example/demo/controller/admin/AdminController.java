...
public class AdminController {
	...
	public String signup(@Validated @ModelAttribute("adminForm") AdminForm adminForm, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			return "signup";
		}

		// adminFormで入力されたデータをadminServiceが持っているadminContactメソッドに渡してデータベースへ保存
